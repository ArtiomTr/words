                    ...
                    <>
                        <div className="word-list__title">
                            ...
                            <Typography variant="body1">
                                {wordGroup.info.description}
                            </Typography>
                            <Typography
                                className="word-list__title-path"
                                variant="body1"
                            >
                                {wordGroup.info.filename}
                            </Typography>
                        </div>
                        {wordGroup.words.length === 0 && (
                            <FullscreenMessage message="Group with 0 words ಠ_ಠ" />
                        )}
                        <List style={{ paddingBottom: 100 }}>
                            {wordGroup.words.map(
                                (value: Word, index: number) => (
                                    <ListItem
                                        dense
                                        key={index}
                                        button
